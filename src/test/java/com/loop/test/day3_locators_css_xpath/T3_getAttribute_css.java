...
public class T3_getAttribute_css {
    ...
    public static void main(String[] args) {
        ...
        // locate home icon of docuport after login or any element after login

        // validate that you logged in
      //  WebElement username = driver.findElement(By.cssSelector("input[type='text']"));
      //  username.sendKeys(DocuportConstants.getUsername());


WebElement loginButton = driver.findElement(By.cssSelector("button[type='submit']"));
loginButton.click();

WebElement homeIcon = driver.findElement(By.cssSelector("your_css_selector_for_home_icon"));
    }
}